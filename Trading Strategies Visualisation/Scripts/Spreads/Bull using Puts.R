spread.bull.put <- function(k1, k2, c1, c2){ # Bull Spread using Puts
  ...
  if (isTRUE(k1 >= k2)){ message("Long put cannot be higher than Short Put") }
  
  else { # if strike prices are fine, than define long and short puts:
...
spread.bull.put(30, 35, 1, 3) # Test
